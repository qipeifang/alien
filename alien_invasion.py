...
def run_game():
	...
	#ME.创建Pause按钮
	quit_button = Quit_Button(ai_settings, screen, "Pause")

	#ME.播放背景音乐
	pygame.mixer.music.load('music/brave.mp3')  
	pygame.mixer.music.play(-1) #重复播放
	
	# 开始游戏主循环
	while True:
		
		gf.check_events(ai_settings, screen, stats, sb, play_button, quit_button, ship,aliens, bullets)
